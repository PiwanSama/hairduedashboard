    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="sidenav-collapse-main">
            ...
            <ul class="navbar-nav">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="#services-menu" data-toggle="collapse" role="button" aria-expanded="true" aria-controls="providers-menu">
                        <i class="ni ni-bullet-list-67 text-custom"></i> {{ __('Services') }}
                    </a>
                ...
                <li class="nav-item">
                    <a class="nav-link" href="#products-menu" data-toggle="collapse" role="button" aria-expanded="true" aria-controls="products-menu">
                        <i class="ni ni-cart text-custom"></i> {{ __('Products') }}
                    </a>
