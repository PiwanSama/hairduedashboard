        ...
        <div class="col">
          <div class="card">
            ...
            <div class="card-header border-0">
              <h3 class="mb-0">BeautyGo Services</h3>
            </div>
            <!-- Product -->
            <div class="card-body">
            <!-- Light table -->
                ...
                <table class="table align-items-center table-flush">
                  ...
                  <tbody class="list">
                      ...
                      <tr>
                          ...
                          <td>{{ $service->sc_price }}</td>
                          <td>{{ $service->service_provider->sc_name }}</td>
                          ...
                          <td class="text-right">
                            <div class="dropdown">
                                ...
                                <div class="dropdown-menu dropdown-menu-right dropdown-menu-arrow">
                                    <form action="{{ route('services.destroy', $service->sc_id) }}" method="post">
                                        @csrf
                                        @method('delete')

                                        <a class="dropdown-item" href="{{ route('services.edit', $service->sc_id) }}">{{ __('Edit') }}</a>
